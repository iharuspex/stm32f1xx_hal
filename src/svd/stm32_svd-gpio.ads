...
--  This spec has been (almost) automatically generated from STM32F103.svd
...
package STM32_SVD.GPIO is
   ...
   type CRx_Register_Pair is record
      MODEx : HAL.Uint2 := 16#0#;
      CNFx  : HAL.UInt2 := 16#1#;
   end record
      with Pack, Size => 4;

   type CRx_Register_Array is array (0 .. 7) of CRx_Register_Pair
      with Component_Size => 4, Size => 32;

   subtype CRL_MODE0_Field is HAL.UInt2;
   subtype CRL_CNF0_Field is HAL.UInt2;
   subtype CRL_MODE1_Field is HAL.UInt2;
   subtype CRL_CNF1_Field is HAL.UInt2;
   subtype CRL_MODE2_Field is HAL.UInt2;
   subtype CRL_CNF2_Field is HAL.UInt2;
   subtype CRL_MODE3_Field is HAL.UInt2;
   subtype CRL_CNF3_Field is HAL.UInt2;
   subtype CRL_MODE4_Field is HAL.UInt2;
   subtype CRL_CNF4_Field is HAL.UInt2;
   subtype CRL_MODE5_Field is HAL.UInt2;
   subtype CRL_CNF5_Field is HAL.UInt2;
   subtype CRL_MODE6_Field is HAL.UInt2;
   subtype CRL_CNF6_Field is HAL.UInt2;
   subtype CRL_MODE7_Field is HAL.UInt2;
   subtype CRL_CNF7_Field is HAL.UInt2;
   ...
   is record
      case As_Array is
         ...
         when True =>
            Arr : CRx_Register_Array;
      end case;
   end record
      with Unchecked_Union, Size => 32;

   for CRL_Field use record
   ...
   for CRL_Register use record
      CNF_MODE at 0 range 0 .. 31;
   end record;

   subtype CRH_MODE8_Field is HAL.UInt2;
   subtype CRH_CNF8_Field is HAL.UInt2;
   subtype CRH_MODE9_Field is HAL.UInt2;
   subtype CRH_CNF9_Field is HAL.UInt2;
   subtype CRH_MODE10_Field is HAL.UInt2;
   subtype CRH_CNF10_Field is HAL.UInt2;
   subtype CRH_MODE11_Field is HAL.UInt2;
   subtype CRH_CNF11_Field is HAL.UInt2;
   subtype CRH_MODE12_Field is HAL.UInt2;
   subtype CRH_CNF12_Field is HAL.UInt2;
   subtype CRH_MODE13_Field is HAL.UInt2;
   subtype CRH_CNF13_Field is HAL.UInt2;
   subtype CRH_MODE14_Field is HAL.UInt2;
   subtype CRH_CNF14_Field is HAL.UInt2;
   subtype CRH_MODE15_Field is HAL.UInt2;
   subtype CRH_CNF15_Field is HAL.UInt2;
